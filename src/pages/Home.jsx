...
const Home = () => {
   return <>
         <section className="relative z-10 w-screen h-full">
            <div className=" z-20 inset-0 bg-[url('./assets/images/home/home-hero.jpg')] bg-cover"></div>
            <div className="py-55 relative z-30 flex justify-start items-center bg-[#00000099]">
                <div className="w-[600px] flex flex-col justify-start ml-40  ">
                    ...
                    <h1 className="text-white w-fit text-7xl font-Playfair Display py-5">Explore the World Like Never Before
</h1>               <h6 className="text-white">Curated journeys to the world's most extraordinary destinations. Let us transform your travel dreams into unforgettable memories.</h6>
